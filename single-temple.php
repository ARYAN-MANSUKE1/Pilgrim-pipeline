...
.single.single-temple.postid-9577 .content-section img { width: 100%; }
	...
	.gj_lang::after, .ta_lang::after, .te_lang::after { content: ""; display: block; clear: both; }
	.hero { clear: both; }
	...
	<div class="container">
		<div class="content-section">
			...
			<div class="ta_lang dis_lang" style="display:none;">
				<?php
				$content = get_field('tamil_content');   // was 'ta_translation' (field doesn't exist); real ACF field is 'tamil_content'
				echo apply_filters('the_content', $content);
				?>
			</div>
			...
			<div class="te_lang dis_lang" style="display:none;">
				<?php
				$content = get_field('telugu_content');  // was 'te_translation' (field doesn't exist); real ACF field is 'telugu_content'
				echo apply_filters('the_content', $content);
				?>
			</div>
